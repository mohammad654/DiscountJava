...
public class Main {
    ...
    private static void viewRecords(JSONArray jsonArray) {
        if (jsonArray.length() == 0) {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                System.out.printf("%d. %s %s, %d\n", i + 1, jsonObject.getString("firstname"), jsonObject.getString("lastname"), jsonObject.getInt("age"), jsonObject.getInt("one"));
            }
        }
    }
    ...
    private static void addRecord(Scanner scanner, JSONArray jsonArray) {
        ...
        System.out.println("Please enter the one:");
    ...
    private static void editRecord(Scanner scanner, JSONArray jsonArray) {
        ...
        System.out.printf("Editing record %d: %s %s, %d\n", recordNumber, jsonObject.getString("firstname"), jsonObject.getString("lastname"), jsonObject.getInt("age"));
        ...
        System.out.println("Please enter the new age (enter 0 to keep the same):");
        int age = scanner.nextInt();
        scanner.nextLine();
        if (age != 0) {
            jsonObject.put("age", age);
